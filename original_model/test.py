...
model = load_model('checkpoint\org\checkpoint_org042809_One_HSN.hdf5')
...
plt.savefig("./result/confusion_matrix_without_normalization01_F.png")
plt.show()
...
cv2.imshow('predict_image',outputs)
cv2.waitKey(0)
